...
export default class WebToLeadLWC extends LightningElement {
   ...
   // picture =  lawPicture + '/Salesforce.png';
    ...
    @wire(getPicklistValues, {recordTypeId: "$leadRecordTypeId", fieldApiName: Lead_STATUS_FIELD  })
  picklistResults1({ error, data }) {
    if (data) {
        //to take value={status} from html
    ...
    */
    ...
    const fields = {}
    fields[Lead_LASTNAME_FIELD.fieldApiName] = this.lastname;
    fields[Lead_FIRSTNAME_FIELD.fieldApiName] = this.firstname;
    fields[Lead_EMAIL_FIELD.fieldApiName] = this.email;
    fields[Lead_PHONENUMBER_FIELD.fieldApiName] = this.phone;
